 ...
 */
final class Version20210514130909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, _id INT DEFAULT NULL, name_cat VARCHAR(255) NOT NULL, INDEX IDX_497DD6346641C530 (_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, doc_task VARCHAR(255) NOT NULL, name_task VARCHAR(255) NOT NULL, topic_task VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_527EDB2519EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
